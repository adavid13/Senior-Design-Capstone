...
export default class Label extends RexLabel {
  constructor(scene, x, y, text, fontSize, align, width, space = 20, backgroundColor) {
    let config = {
      x, y,
      width,
      height: 1,
    ...
    if (backgroundColor) {
      ...
      config.space = { top: space, right: space, bottom: space, left: space };
    }
